...
(function ($) {
    ...
    $.fn.richText = function (options) {
        ...
        var closesvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16"><path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/></svg>';
        var $dropdownOuter = $('<div />', {class: "richText-dropdown-outer"});
        var $dropdownClose = $('<span />', {
            class: "richText-dropdown-close",
            html: '<span title="' + settings.translations.close + '">' + closesvg + '</span></span>'
        });
        ...
        $linksForm.append(
            $formItem.clone()
                ...
                .append($formInput.clone().attr("id", "url").attr('class', 'form-control'))
        );
        $linksForm.append(
            $formItem.clone()
        ...
        function init() {
            ...
            $bottomToolbar = $('<div />', {class: 'richText-toolbar d-flex flex-end'});
            // if (!settings.preview) {
            ...
            //     }));
            // }
            $bottomToolbar.append($('<button />', {
                    class: 'richText-saveChanges btn btn-success ms-auto m-2 py-1 px-4',
                    type: 'button',
                    text: 'Save',
                }));
